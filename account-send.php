			...
			<div class="row">
				<div class="account__block">
					<div class="account__top-wrap">
						<div class="account__block-title">Send funds</div>
					</div>
					<form action="">
						...
						<div class="form__label">
							...
							<div class="label__row">
								<div class="label__left-col">
									<input class="form__text-input form__text-input--max form__text-input--btc" id="btc-amount" type="text" name="btc-amount">
								</div>
								<div class="label__right-col label__right-col--arrow">
									<input class="form__text-input form__text-input--usd" id="btc-amount" type="text" name="btc-amount">
								</div>
							</div>
						</div>
						<div class="form__label">
							<div class="label__row">
								...
								<div class="label__right-col">
									<label class="account__checkbox account__checkbox--position form__checkbox">
									...
									<label class="form__text-input--hide">
										...
										<input class="form__text-input form__text-input--btc" id="btc-amount" type="text" name="btc-amount" value="0.0003">
									</label>
								</div>
							</div>
						</div>
