	...
	<main class="main def-page account">
		<div class="container">
			<div class="account__block">
				...
				<div class="form__label">
					...
					<div class="label__row">
						<div class="label__left-col">
							<input class="form__text-input form__text-input--max" id="btc-amount" type="text" name="btc-amount" value="0.32671872">
						</div>
					...
					<div class="label__row">
						...
						<div class="label__right-col">
							<label class="account__checkbox form__checkbox">
								<input class="account__checkbox-input form__checkbox-input" type="checkbox" name="account-option-support-bitamp" value="Support Bitamp">
				...
				<button class="btn-active account__btn-send">SEND PAYMENT</button>
			</div>
		</div>
	</main>
